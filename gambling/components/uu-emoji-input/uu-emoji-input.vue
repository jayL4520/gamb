		...
		<view class="comment-popup" @click.stop>
			<view class="comment-box">
				...
				<view class="comment-input-area">
					<textarea class="comment-input" v-model="commentText" placeholder="我也说一句..." :focus="modelValue"
						@confirm="handleSubmit" />
					<view class="toolbar">
						<text class="emoji-btn" @tap="toggleEmojiPanel">😊</text>
						<button class="submit-btn" :class="{ active: commentText.trim() }"
							@tap="handleSubmit">回复</button>
					</view>
				</view>

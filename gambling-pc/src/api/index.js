...
export const getNewDataApiG = (params) => {
  ...
  let res1 = service({
    ...
    baseURL:
      lotCode == "mo"
        ? "https://api.00853lhc.com/" + "api"
        : "https://apiam.ad771.cn", //'/'+(lotCode+"Api"),
    url:
      lotCode == "mo"
        ? `IssueOpenInfo?issue=${params.issue}&lotteryId=2032`
        : "/Lot_34/Draw/NextDrawingTime",
    method: "get",
  });
  return res1;
};
...
export const getSevenStarCurrentApi = () => {
  return qxcService({
    url: "/lottery/current?draw_mode=bingo_sevenstar",
    method: "get",
    timeout: 10000,
  });
};
